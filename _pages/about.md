...
Currently, my main project experiences are mostly course experiments. I will gradually organize them and upload them.

(╥╯^╰╥) 

# Blog

ToDo list is as follows !!! (╥╯^╰╥) (Working Stages: from **skeleton** to **flesh** and then to **soul**. **If you can't wait and feel eager, please feel free to urge me.**) 

* personal summary about Statistical Machine Learning (**(skeleton,flesh)**)
* personal summary about  Deep Learning(**($-\infty$,skeleton]**)
* personal summary about Diffusion Model (**(flesh,soul)**)
* personal summary about Matrix & Linear Transformation(**More accumulation is needed.**<(￣︶￣)>)
